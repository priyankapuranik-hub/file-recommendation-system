...
class FileRecommendationSystem:
    def __init__(self, base_path: str = None, embedding_model: str = 'all-MiniLM-L6-v2'):
        ...
        self.base_path = os.path.join(base_path, "Documents") if not base_path.endswith("Documents") else base_path
...
if __name__ == "__main__":
    ...
    results = recommender.recommend_files("internship offer letter")
